    ...
    <AuthenticatedLayout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ stats.total_logbooks || 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ stats.pending_logbooks || 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ stats.approved_logbooks || 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">Revisi</p>
                        <p class="text-2xl font-semibold text-gray-900">{{ stats.revision_logbooks || 0 }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="px-6 py-4 border-b border-gray-100">
                <h2 class="text-xl font-semibold text-gray-900">Daftar Logbook</h2>
            </div>
            ...
            <div v-if="logbooks.length === 0" class="p-12 text-center">
                ...
                <p class="text-gray-500 mb-4">Mulai catat kegiatan harian Anda dengan membuat logbook pertama.</p>
                <Link
                    :href="route('profile.logbooks.create')"
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-4 text-sm text-gray-500">
                                ...
                                <span class="flex items-center">
                                    ...
                                    {{ logbook.division ? logbook.division.name : 'Tidak ada divisi' }}
                                </span>
                                <span v-if="logbook.comments && logbook.comments.length > 0" class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10m0 0V6a2 2 0 00-2-2H9a2 2 0 00-2 2v2m10 0v10a2 2 0 01-2 2H9a2 2 0 01-2-2V8m10 0V6a2 2 0 00-2-2H9a2 2 0 00-2 2v2" />
                                    </svg>
