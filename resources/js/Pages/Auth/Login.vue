    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Masuk ke akun GrowithBI - Program Magang Bank Indonesia KPW Lampung</p>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-8">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        Belum punya akun?
                        <Link :href="route('register')" class="font-semibold text-blue-600 hover:text-blue-800 transition-colors">
                            Daftar Sekarang
                        </Link>
                    </p>
                </div>
