    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
        <div class="w-full max-w-2xl">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Bergabung dengan GrowithBI</h2>
                <p class="text-gray-600">Program magang eksklusif Bank Indonesia KPW Lampung untuk mahasiswa</p>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-8">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    <option value="peserta">🎓 Mahasiswa Peserta Magang</option>
                                    <option value="admin">👨‍💼 Admin Bank Indonesia</option>
                                </select>
                            </div>
                            <div v-if="form.errors.role" class="mt-2 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                </svg>
                                {{ form.errors.role }}
                        ...
                        <div>
                            ...
                            <div v-if="form.errors.phone" class="mt-2 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                </svg>
                                {{ form.errors.phone }}
                    ...
                    <div>
                        ...
                        <div v-if="form.errors.address" class="mt-2 text-sm text-red-600 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                            </svg>
                            {{ form.errors.address }}
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <button
                                    ...
                                    class="absolute inset-y-0 right-0 pr-3 flex items-center"
                                >
                                    <svg v-if="!showPasswordConfirmation" class="h-5 w-5 text-gray-400 hover:text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                                        <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/>
                                    </svg>
                                    <svg v-else class="h-5 w-5 text-gray-400 hover:text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        Sudah punya akun?
                        <Link :href="route('login')" class="font-semibold text-blue-600 hover:text-blue-800 transition-colors">
                            Masuk di sini
                        </Link>
                    </p>
                </div>
                ...
                <div class="mt-4 text-center">
                    <Link href="/" class="text-sm text-gray-500 hover:text-gray-700 transition-colors">
                        ← Kembali ke Beranda
                    </Link>
                </div>
            </div>
