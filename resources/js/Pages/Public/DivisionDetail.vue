            ...
            >
                ...
                >
                    <div class="bg-white px-6 pt-6 pb-4 sm:p-8 sm:pb-6">
                        <div class="sm:flex sm:items-start">
                            ...
                            >
                                ...
                                <div v-if="notification.type === 'success' && redirectCountdown > 0" class="mt-4">
                                    <div class="flex items-center justify-between text-xs text-gray-500 mb-2">
                                        <span>Mengarahkan ke profil...</span>
                    ...
                    >
                        ...
                        >
                            {{ notification.type === 'success' ? 'Tutup' : 'OK' }}
                        </button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap items-center gap-4 mb-4">
                                <div class="flex items-center text-blue-100">
                                    ...
                                    <span class="text-sm">Kota Bandung • Jakarta Pusat</span>
                                </div>
                                <div class="flex items-center text-blue-100">
                                    <svg
                                        class="w-4 h-4 mr-2"
                                ...
                                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div class="text-center">
                                            ...
                                            <h4 class="font-semibold text-gray-900 mb-2">Jenjang Pendidikan</h4>
                                            <p class="text-gray-700 font-medium">S1</p>
                                        </div>
                                        <div class="text-center">
                                            ...
                                            <h4 class="font-semibold text-gray-900 mb-2">Jurusan</h4>
                                            <p class="text-gray-700 text-sm leading-relaxed">Semua Jurusan, Manajemen Bisnis, Manajemen SDM, Administrasi, Psikologi</p>
                                        </div>
                                        <div class="text-center">
                                            ...
                                            <h4 class="font-semibold text-gray-900 mb-2">IPK Minimal</h4>
                                            <p class="text-gray-700 font-bold text-lg">3.0</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 text-center">
                                            ...
                                            <h4 class="font-semibold text-gray-900 text-sm">CV</h4>
                                        </div>
                                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 text-center">
                                            ...
                                            <h4 class="font-semibold text-gray-900 text-sm">KTP</h4>
                                        </div>
                                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 text-center">
                                            ...
                                            <h4 class="font-semibold text-gray-900 text-sm">Transkrip Nilai</h4>
                                        </div>
                                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 text-center col-span-full sm:col-span-1">
                                            <div class="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-3">
                                                <svg class="w-5 h-5 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C20.168 18.477 18.582 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                                </svg>
                                            </div>
                                            <h4 class="font-semibold text-gray-900 text-sm">Ijazah/Surat Keterangan Lulus</h4>
                                            <p class="text-xs text-gray-500 mt-1">(untuk Fresh Graduate)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="space-y-4">
                                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 flex items-center justify-between">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <h4 class="font-semibold text-gray-900">Durasi Program</h4>
                                                    <p class="text-sm text-gray-600">Lamanya program magang</p>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <span class="text-lg font-bold text-blue-600">6 bulan</span>
                                            </div>
                                        </div>
                                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 flex items-center justify-between">
                                            <div class="flex items-center">
                                                <div class="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center mr-4">
                                                    <svg class="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a4 4 0 118 0v4m-4 12v-2m0 0V9a2 2 0 012-2h6a2 2 0 012 2v3"></path>
                                                    </svg>
                                                </div>
                                                <div>
                                                    <h4 class="font-semibold text-gray-900">Penutupan Lamaran</h4>
                                                    <p class="text-sm text-gray-600">Batas akhir pendaftaran</p>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <span class="text-lg font-bold text-red-600">{{ division.application_deadline || "31 Agustus 2025" }}</span>
                                            </div>
                                        </div>
                                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 flex items-center justify-between">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <h4 class="font-semibold text-gray-900">Pengumuman Hasil</h4>
                                                    <p class="text-sm text-gray-600">Pengumuman lolos seleksi</p>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <span class="text-lg font-bold text-green-600">{{ division.selection_announcement || "31 Agustus 2025" }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                        ...
                                        <div class="space-y-4">
                                            <div class="flex items-start p-4 bg-indigo-50 rounded-lg">
                                                <div class="w-8 h-8 bg-indigo-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">1</div>
                                                <div>
                                                    <p class="text-gray-800 leading-relaxed">Mendukung implementasi data-data yang ada di <strong>People Analytic</strong>.</p>
                                                </div>
                                            </div>
                                            <div class="flex items-start p-4 bg-indigo-50 rounded-lg">
                                                <div class="w-8 h-8 bg-indigo-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">2</div>
                                                <div>
                                                    <p class="text-gray-800 leading-relaxed">Membantu pembuatan kertas kerja maupun pengolahan data secara sederhana yang dibutuhkan.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-gradient-to-r from-emerald-50 to-green-50 p-6 rounded-xl border border-emerald-100">
                                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                                        ...
                                        <div class="flex items-start p-4 bg-emerald-50 rounded-lg">
                                            <div class="w-8 h-8 bg-emerald-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                                </svg>
                                            </div>
                                            <div>
                                                <p class="text-gray-800 leading-relaxed">Mahasiswa <strong>S1</strong> dalam bidang <strong>manajemen bisnis</strong>, <strong>manajemen SDM</strong>, dan <strong>administrasi</strong> atau jurusan lain yang relevan.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
const handleApply = async () => {
    ...
    try {
        ...
        const existingApplicationResponse = await window.axios.get(`/applications/check/${props.division.id}`);
        ...
        if (missingProfile.length > 0) {
            ...
            setTimeout(() => {
                window.location.href = `/profile?division_id=${props.division.id}&missing_fields=${missingProfile.map(f => f.field).join(',')}`;
            }, 3000);
            isLoading.value = false;
            return;
        }
