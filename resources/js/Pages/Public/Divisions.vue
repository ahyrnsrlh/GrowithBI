    ...
    <div class="bg-white shadow-sm border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div class="text-center">
          ...
          <p class="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div class="mb-8 sm:mb-12">
          <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8">
            <div class="flex flex-col space-y-6 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-6">
              ...
              <div class="relative flex-1 lg:max-w-2xl">
                ...
                >
                <div class="pointer-events-none absolute right-3 sm:right-4 top-1/2 -translate-y-1/2">
              ...
              <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                <label class="inline-flex items-center gap-2 sm:gap-3 text-base sm:text-lg text-gray-700 font-medium">
                  <input type="checkbox" v-model="onlyAvailable" class="h-4 w-4 sm:h-5 sm:w-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                  <span class="whitespace-nowrap">Hanya yang tersedia</span>
                </label>
                <select v-model="sortBy" class="w-full sm:w-auto rounded-lg sm:rounded-xl border border-gray-300 bg-white px-4 sm:px-6 py-2 sm:py-3 text-base sm:text-lg font-medium focus:border-blue-500 focus:outline-none">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-6 sm:gap-8">
          <div 
            ...
            <div class="p-6 sm:p-8 flex-1">
              ...
              <div class="flex items-start space-x-3 sm:space-x-4 mb-4 sm:mb-6">
                <div class="flex-shrink-0">
                  <div class="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center text-white text-lg sm:text-2xl font-bold group-hover:scale-105 transition-transform">
                    {{ (division.name || 'D')[0] }}
                  </div>
                </div>
                <div class="flex-1 min-w-0">
                  <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-1 sm:mb-2 group-hover:text-blue-600 transition-colors leading-tight">
                    {{ division.name }}
                  </h3>
              ...
              <div class="flex flex-wrap gap-2 mb-4 sm:mb-6">
                <span class="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm font-semibold bg-green-100 text-green-800">
                  <span class="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-green-500 rounded-full mr-1 sm:mr-2"></span>
                  Tersedia
                </span>
                <span class="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm font-medium bg-blue-50 text-blue-700">
                  6 bulan
                </span>
              ...
              <!-- Description -->
              <p class="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 sm:mb-8 line-clamp-3">
                {{ division.description }}
              </p>
            </div>

            <!-- Card Footer -->
            <div class="px-6 sm:px-8 py-4 sm:py-6 bg-gray-50 border-t border-gray-100 mt-auto">
        ...
        <!-- Empty State -->
        <div v-if="sortedFiltered.length === 0" class="text-center py-16 sm:py-24">
          <div class="mx-auto w-24 h-24 sm:w-32 sm:h-32 bg-gray-100 rounded-full flex items-center justify-center mb-6 sm:mb-8">
            <svg class="w-12 h-12 sm:w-16 sm:h-16 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
            </svg>
          </div>
          <h3 class="text-xl sm:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">Tidak ada divisi ditemukan</h3>
          <p class="text-gray-600 max-w-md mx-auto text-base sm:text-lg">Coba ubah filter pencarian Anda atau gunakan kata kunci yang berbeda</p>
        </div>

        <!-- Loading State -->
        <div v-if="!divisions.length" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-6 sm:gap-8">
          <div v-for="n in 8" :key="n" class="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 overflow-hidden animate-pulse">
            <div class="p-8">
