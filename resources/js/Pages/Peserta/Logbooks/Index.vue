    ...
    >
            ...
            <div class="bg-gradient-to-r from-red-500 to-red-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold">{{ stats.revision_logbooks || 0 }}</p>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                <p class="text-gray-600 text-sm line-clamp-3">
                                    {{ logbook.activities || 'Tidak ada deskripsi aktivitas' }}
                                </p>
                            </div>
                            ...
                            <div class="flex items-center justify-between text-sm text-gray-500 mb-4">
                                ...
                                <div v-if="logbook.attachments && logbook.attachments.length > 0" class="flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex space-x-2">
                                    ...
                                    <Link
                                        v-if="logbook.status === 'draft' || logbook.status === 'revision'"
                                ...
                                <!-- Comments Count -->
                                <div v-if="logbook.comments_count > 0" class="flex items-center text-sm text-gray-500">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div v-else class="p-12 text-center">
                ...
                <p class="text-gray-500 mb-6">Mulai catat aktivitas harian magang Anda</p>
                <Link
                    :href="route('peserta.logbooks.create')"
