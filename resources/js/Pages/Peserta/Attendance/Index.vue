<template>
    ...
    <div
        class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-gray-50"
    >
        <!-- Header Profesional Bank Indonesia -->
        <div
            class="sticky top-0 z-50 bg-gradient-to-r from-blue-800 to-indigo-900 shadow-lg border-b-4 border-[#C9A227]"
        >
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <div
                                class="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/20"
                            >
                                <svg
                                    class="h-6 w-6 text-[#C9A227]"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-200">
                                    Kelola absensi harian dengan mudah dan
                                    akurat
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div
                            class="hidden sm:block bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/20"
                        >
                            <div
                                class="text-xs font-medium text-blue-200 mb-0.5"
                            >
                                {{ todayFormatted }}
                            </div>
                        ...
                        <div
                            class="w-10 h-10 bg-white rounded-full flex items-center justify-center border-2 border-[#C9A227] shadow-lg"
                        >
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    >
                        <div
                            class="bg-gradient-to-r from-blue-800 to-indigo-900 px-6 py-4"
                        >
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2
                                        class="text-sm font-semibold text-blue-200 uppercase tracking-wide"
                                    >
                                        Status Hari Ini
                                    </h2>
                                    <p
                        ...
                        <div class="p-6">
                            <div v-if="todayAttendance" class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <!-- Check-in -->
                                    <div
                                        class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-4 border border-emerald-200 shadow-sm"
                                    >
                                        <div
                                    ...
                                    <!-- Check-out -->
                                    <div
                                        class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-4 border border-red-200 shadow-sm"
                                    >
                                        <div
                                            class="flex items-center space-x-2 mb-3"
                                        >
                                            <div
                                                class="w-8 h-8 bg-red-500 rounded-lg flex items-center justify-center shadow-md"
                                            >
                                                <svg
                                                    class="h-5 w-5 text-white"
                                                    fill="none"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <div class="relative">
                                ...
                                >
                                    <div
                                        class="w-14 h-14 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform"
                                    >
                                        <svg
                                            class="h-8 w-8"
                                            fill="none"
                ...
                <div class="space-y-6">
                    ...
                    >
                        <h3
                            class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-4 flex items-center"
                        >
                            <svg
                                class="h-5 w-5 text-[#C9A227] mr-2"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                        ...
                        <div class="space-y-3">
                            ...
                            >
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-emerald-500 rounded-lg flex items-center justify-center shadow-sm"
                                    >
                                        <svg
                                            class="h-5 w-5 text-white"
                                            fill="currentColor"
                            ...
                            >
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center shadow-sm"
                                    >
                                        <svg
                                            class="h-5 w-5 text-white"
                                            fill="currentColor"
                            ...
                            >
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-gray-400 rounded-lg flex items-center justify-center shadow-sm"
                                    >
                                        <svg
                                            class="h-5 w-5 text-white"
                                            fill="currentColor"
                    ...
                    >
                        <h3
                            class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-4"
                        >
                            Grafik Kehadiran
                        </h3>
                        <div
                            class="h-48 flex items-end justify-around space-x-2"
                        >
                            <div class="flex-1 flex flex-col items-center">
                                <div
                                    ...
                                    :style="{
                                        height: getBarHeight(stats.onTime || 0),
                                    }"
                                ></div>
                                <p
                                    class="text-xs font-semibold text-emerald-700 mt-2"
                                >
                                    Hadir
                                </p>
                            </div>
                            <div class="flex-1 flex flex-col items-center">
                                <div
                                    ...
                                    :style="{
                                        height: getBarHeight(stats.late || 0),
                                    }"
                                ></div>
                                <p
                                    class="text-xs font-semibold text-orange-700 mt-2"
                                >
                                    Terlambat
                                </p>
                            </div>
                            <div class="flex-1 flex flex-col items-center">
                                <div
                                    ...
                                    :style="{
                                        height: getBarHeight(stats.absent || 0),
                                    }"
                                ></div>
                                <p
            ...
            <!-- Riwayat Absensi -->
            <div
                class="mt-6 bg-white rounded-2xl border border-gray-200 shadow-md overflow-hidden"
            >
                <div
                    class="bg-gradient-to-r from-blue-800 to-indigo-900 px-6 py-4"
                >
...
const handleCheckIn = () => {
    ...
    console.log("Camera modal should show now:", showCamera.value);
};
