        ...
        <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-100 text-sm">Monitoring Absensi Peserta Magang</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-white/90 rounded-xl shadow-sm border border-blue-100/50 p-6">
                        <div class="flex items-center">
                    ...
                    <div class="bg-white/90 rounded-xl shadow-sm border border-emerald-100/50 p-6">
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-emerald-600 rounded-lg flex items-center justify-center">
                                <CheckCircleIcon class="h-5 w-5 text-white" />
                            </div>
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-600">Absensi Valid</p>
                                <p class="text-2xl font-bold text-emerald-600">{{ stats.valid_attendances }}</p>
                            </div>
                        </div>
                    </div>

                    <div class="bg-white/90 rounded-xl shadow-sm border border-rose-100/50 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-600">Absensi Tidak Valid</p>
                                <p class="text-2xl font-bold text-rose-600">{{ stats.invalid_attendances }}</p>
                            </div>
                        </div>
                    </div>

                    <div class="bg-white/90 rounded-xl shadow-sm border border-amber-100/50 p-6">
                        <div class="flex items-center">
                ...
                <div class="bg-white/90 rounded-xl shadow-sm border border-blue-100/50 p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            >
                                <ArrowPathIcon 
                                    :class="['h-4 w-4 mr-1', isRefreshing ? 'animate-spin' : '']" 
                                />
                                Refresh
                            </button>
                        </div>
                    ...
                    <div class="mb-4">
                        <div class="flex flex-wrap items-center space-x-6 text-sm">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-gray-600">Kantor (Bank Indonesia KPw Lampung)</span>
                            </div>
                            <div class="flex items-center space-x-2">
                    ...
                    <div class="relative">
                        ...
                        >
                            <div class="text-center">
                                ...
                                <p class="text-sm text-gray-600 mt-2">Memuat peta...</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Attendance List -->
                <div class="mt-8 bg-white/90 rounded-xl shadow-sm border border-blue-100/50 p-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="attendance in attendances" :key="attendance.id" class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-600">{{ attendance.division }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span 
                                            :class="attendance.is_valid_location ? 'text-emerald-600' : 'text-rose-600'"
                                            class="inline-flex items-center text-sm font-medium"
                                        >
                                            <div 
                                                :class="attendance.is_valid_location ? 'bg-emerald-500' : 'bg-rose-500'"
...
const initializeMap = () => {
    ...
    map.value = L.map('map').setView([props.officeLocation.latitude, props.officeLocation.longitude], 15);
    ...
    const officeMarker = L.marker([props.officeLocation.latitude, props.officeLocation.longitude], { icon: officeIcon })
        .addTo(map.value)
        .bindPopup(`
            <div class="text-center">
...
const addAttendanceMarkers = () => {
    ...
    attendances.value.forEach(attendance => {
        const markerColor = attendance.is_valid_location ? '#10b981' : '#ef4444';
        ...
        const marker = L.marker([attendance.latitude, attendance.longitude], { icon: attendanceIcon })
            .addTo(map.value)
            .bindPopup(`
                <div class="min-w-48">
...
onMounted(() => {
    ...
    if (window.Echo) {
        window.Echo.channel('admin-maps')
            .listen('AttendanceUpdated', (e) => {
                console.log('Real-time attendance update:', e);
                
                // Update attendances data
                const existingIndex = attendances.value.findIndex(a => a.id === e.attendance.id);
                if (existingIndex !== -1) {
...
const showNotification = (attendance) => {
    ...
    console.log(`New attendance: ${attendance.user_name} - ${attendance.status}`);
};
</script>
