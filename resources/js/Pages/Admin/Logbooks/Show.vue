        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                <div>
                    ...
                    <h1 class="text-3xl font-bold text-gray-900">{{ logbook.title }}</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                        <h2 class="text-xl font-semibold text-gray-900 mb-6">Detail Logbook</h2>
                        
                        <div class="space-y-6">
                            <div>
                                <h3 class="text-sm font-medium text-gray-700 mb-2">Aktivitas yang Dilakukan</h3>
                                <p class="text-gray-900 leading-relaxed">{{ logbook.activities }}</p>
                            </div>
                            
                            <div v-if="logbook.learning_outcome">
                                <h3 class="text-sm font-medium text-gray-700 mb-2">Hasil Pembelajaran</h3>
                                <p class="text-gray-900 leading-relaxed">{{ logbook.learning_outcome }}</p>
                            </div>
                            
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <h3 class="text-sm font-medium text-gray-700 mb-2">Durasi</h3>
                                    <p class="text-gray-900">{{ logbook.duration }} jam</p>
                                </div>
                                <div v-if="logbook.user.division">
                                    <h3 class="text-sm font-medium text-gray-700 mb-2">Divisi</h3>
                                    <p class="text-gray-900">{{ logbook.user.division.name }}</p>
                                </div>
                            </div>
                            
                            <div v-if="logbook.attachments && logbook.attachments.length > 0">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h2 class="text-xl font-semibold text-gray-900 mb-6">Komentar & Feedback</h2>
                        
                        <!-- Existing Comments -->
                        <div v-if="logbook.comments && logbook.comments.length > 0" class="space-y-4 mb-6">
                            <div
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Informasi Peserta</h3>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-900">{{ logbook.user.name }}</p>
                                    <p class="text-sm text-gray-500">{{ logbook.user.email }}</p>
                                </div>
                            </div>
                            
                            <div v-if="logbook.user.division" class="pt-3 border-t border-gray-200">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ formatDateTime(logbook.created_at) }}</p>
                                </div>
                            </div>
                            
                            <div v-if="logbook.updated_at !== logbook.created_at" class="flex items-start space-x-3">
                                <div class="w-2 h-2 bg-yellow-500 rounded-full mt-2"></div>
                                <div>
                                    <p class="text-sm font-medium text-gray-900">Diperbarui</p>
                                    <p class="text-xs text-gray-500">{{ formatDateTime(logbook.updated_at) }}</p>
                                </div>
                            </div>
                            
                            <div v-if="logbook.approved_at" class="flex items-start space-x-3">
                                <div class="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                                <div>
                                    <p class="text-sm font-medium text-gray-900">Disetujui</p>
                                    <p class="text-xs text-gray-500">{{ formatDateTime(logbook.approved_at) }}</p>
                                    <p v-if="logbook.approver" class="text-xs text-gray-400">oleh {{ logbook.approver.name }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
