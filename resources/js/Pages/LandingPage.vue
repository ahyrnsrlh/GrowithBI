<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center">
                        ...
                        <h1 class="ml-3 text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                            GrowithBI
                        </h1>
                    </div>
        ...
        <section class="relative overflow-hidden py-20 lg:py-32">
            ...
            <div class="absolute top-40 right-20 w-16 h-16 bg-indigo-200 rounded-full opacity-30 animate-pulse"></div>
            <div class="absolute bottom-20 left-20 w-12 h-12 bg-purple-200 rounded-full opacity-25 animate-bounce" style="animation-delay: 1s"></div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Teknologi Modern</h3>
                        <p class="text-gray-600">Menggunakan tools terkini seperti Power BI, Tableau, Python, dan SQL</p>
                    </div>
        ...
        <section id="divisions" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8" v-if="divisions.length > 0">
                    <div v-for="division in divisions" :key="division.id" 
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-3">{{ division.name }}</h3>
                        <p class="text-gray-600 mb-6 leading-relaxed">{{ division.description }}</p>
                ...
                <div v-else class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div v-for="n in 6" :key="n" class="bg-gray-100 rounded-2xl p-8 animate-pulse">
                        <div class="w-16 h-16 bg-gray-300 rounded-xl mb-6"></div>
