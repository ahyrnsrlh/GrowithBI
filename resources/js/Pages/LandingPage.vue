    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <section class="relative overflow-hidden py-20 lg:py-32">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    >
                        Platform magang terdepan yang menggabungkan teknologi
                        modern dengan pengalaman praktis dalam dunia Business
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            Didampingi oleh praktisi berpengalaman di bidang
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            Mengerjakan project nyata dengan data dan kasus
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            Program magang yang fleksibel, bisa disesuaikan
                            dengan jadwal kuliah Anda
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                            GrowithBI adalah platform magang terdepan yang fokus
                            pada pengembangan talenta di bidang Business
                            Intelligence dan Data Analytics. Kami berkomitmen
                            untuk memberikan pengalaman praktis yang relevan
                            dengan kebutuhan industri.
                        </p>
                        <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                            Dengan menggabungkan pembelajaran teoritis dan
                            praktik langsung, kami mempersiapkan peserta magang
                            untuk menjadi profesional yang siap berkontribusi di
                            dunia kerja.
                        </p>
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <p class="text-blue-100 mb-6">
                                Menjadi platform magang terdepan yang
                                menghasilkan talenta-talenta terbaik di bidang
                                Business Intelligence dan Data Analytics.
                            </p>
        ...
        <section class="py-20 bg-gradient-to-r from-blue-600 to-indigo-600">
            <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                ...
                <p class="text-xl text-blue-100 mb-8 leading-relaxed">
                    Bergabunglah dengan ribuan peserta lainnya yang telah
                    mengembangkan karir mereka bersama GrowithBI
                </p>
        ...
        <footer id="contact" class="bg-gray-900 text-white py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="lg:col-span-2">
                        ...
                        <p class="text-gray-300 mb-6 max-w-md">
                            Platform magang terdepan untuk mengembangkan karir
                ...
                >
                    <p>
                        &copy; 2025 GrowithBI. All rights reserved. Made with ❤️
        ...
        divisions.value = [
            {
                ...
                name: "Data Analytics",
                description:
                    "Pelajari cara menganalisis data dan membuat insights bisnis yang actionable menggunakan tools modern.",
                quota: 10,
                is_active: true,
            },
            {
                ...
                description:
                    "Kuasai pembuatan dashboard dan reporting untuk mendukung pengambilan keputusan bisnis.",
                quota: 8,
                is_active: true,
            },
            {
                ...
                name: "Data Science",
                description:
                    "Eksplorasi machine learning dan predictive analytics untuk menyelesaikan masalah bisnis.",
                quota: 6,
                is_active: true,
            },
        ];
