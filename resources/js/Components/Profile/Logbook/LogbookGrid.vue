                    ...
                    >
                        ...
                        >
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button
                                    v-if="logbook?.status !== 'approved'"
                                    @click="$emit('delete', logbook.id)"
                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 transition-all duration-200"
                                >
                                    <svg
                                        class="w-4 h-4"
                                        fill="none"
