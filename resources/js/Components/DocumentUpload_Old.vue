<template>
    ...
    >
        <div class="flex items-center justify-between mb-4">
            ...
            <div
                v-if="currentFile"
                class="flex items-center text-green-600 bg-green-100 px-2 py-1 rounded-full"
            >
        ...
        <div class="mt-4 p-3 bg-gray-50 rounded-lg">
            ...
            >
                ...
                >
                <span class="flex items-center"
                    ><i class="fas fa-file-alt mr-1.5 text-green-500"></i>PDF,
                    JPG, PNG</span
                >
                <span v-if="required" class="flex items-center"
                    ><i class="fas fa-asterisk mr-1.5 text-red-500"></i>Wajib
                    diisi</span
                >
            </div>
        </div>
