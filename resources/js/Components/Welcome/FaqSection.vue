<template>
    <section
        id="faq"
        class="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-white to-blue-50/30 relative z-10"
    >
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                <div
                    class="inline-flex items-center gap-3 bg-blue-100/80 backdrop-blur-sm border border-blue-200/50 text-blue-700 px-5 py-2.5 rounded-full text-xs sm:text-sm font-semibold mb-6 shadow-lg"
                >
                    <div
                ...
                <h2
                    class="text-2xl sm:text-3xl lg:text-5xl font-bold mb-5 sm:mb-6 leading-tight"
                >
                ...
                <p
                    class="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed font-light"
                >
            ...
            <div class="grid md:grid-cols-4 gap-6 sm:gap-8">
                ...
                >
                    <div
                        class="bg-white/80 backdrop-blur-lg border border-white/40 rounded-2xl shadow-lg p-5 sm:p-6 md:sticky md:top-24"
                    >
                        <h3
                ...
                >
                    ...
                    >
                        <button
                            ...
                            class="w-full px-4 sm:px-6 py-4 sm:py-5 text-left flex justify-between items-center hover:bg-blue-50/50 transition-colors duration-300"
                        >
                            <span
                                class="font-semibold text-gray-900 text-sm sm:text-base group-hover:text-blue-700 transition-colors duration-300 flex-1 pr-4"
                            >
                                {{ item.q }}
                            </span>
                            <div
                        ...
                        <div
                            ...
                            class="px-4 sm:px-6 pb-5 text-sm sm:text-base text-gray-600 leading-relaxed border-t border-gray-100 bg-gray-50/30 animate-in fade-in-50 duration-300"
                        >
                            {{ item.a }}
                        </div>
                    </div>
                    ...
                    <div
                        class="mt-8 p-5 sm:p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-200/50 text-center"
                        data-aos="fade-up"
                    >
                        <div class="mb-4">
                            <svg
