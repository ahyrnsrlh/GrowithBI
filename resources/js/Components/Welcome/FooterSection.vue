            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                >
                    ...
                    <div class="flex space-x-4">
                        <a href="#" aria-label="Twitter" class="w-10 h-10 bg-blue-700 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors shadow-md"
                            ><svg
                            ...
                            >
                                ...
                                /></svg
                        ></a>
                        <a href="#" aria-label="LinkedIn" class="w-10 h-10 bg-blue-700 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors shadow-md"
                            ><svg
                                class="w-5 h-5 text-white"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
                                ...
                                /></svg
                        ></a>
                        <a href="#" aria-label="Pinterest" class="w-10 h-10 bg-blue-700 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors shadow-md"
                            ><svg
                                class="w-5 h-5 text-white"
                                fill="currentColor"
                                viewBox="0 0 24 24"
