                        ...
                        <div class="flex justify-between items-center py-4">
                            ...
                            <div class="flex items-center">
                                <Link href="/" class="flex items-center">
                                    ...
                                    />
                                    <span class="ml-3 text-xl sm:text-2xl font-bold text-gray-900">
                                        GrowithBI
                                    </span>
                                </Link>
                            </div>
                            ...
                            <nav class="hidden md:flex items-center space-x-8">
                                <Link href="/divisions" class="text-gray-700 hover:text-blue-600 transition-colors duration-200 font-medium">
                                    Kriteria
                                </Link>
                                <Link href="/about" class="text-gray-700 hover:text-blue-600 transition-colors duration-200 font-medium">
                                    Benefit
                                </Link>
                                <Link href="/requirements" class="text-gray-700 hover:text-blue-600 transition-colors duration-200 font-medium">
                                    Persyaratan
                                </Link>
                                <Link href="/faq" class="text-gray-700 hover:text-blue-600 transition-colors duration-200 font-medium">
                                    FAQ
                                </Link>
                            </nav>
