...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav
                class="border-b border-blue-600 bg-gradient-to-r from-blue-800 to-indigo-900 shadow-lg"
            >
                ...
                <div
                    ...
                    class="sm:hidden bg-gradient-to-r from-blue-800 to-indigo-900"
                >
                    ...
                    <div
                        class="border-t border-blue-600 border-opacity-40 pb-1 pt-4"
                    >
                        <div class="px-4">
